...
public class JmsActivationSpec implements ActivationSpec {
    ...
    private String resourceAdapterJndiParameters;
    ...
    public void setResourceAdapterJndiParameters(String jndiParameters) {
        this.resourceAdapterJndiParameters = jndiParameters;
    }

    public String getResourceAdapterJndiParameters() {
        return this.resourceAdapterJndiParameters;
    }
