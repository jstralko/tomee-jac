...
public class JmsActivation implements ExceptionListener {
    ...
    private void setupActivation() throws Exception {
        ...
        try {
            ...
            Context ctx = convertStringToContext(spec.getJndiParameters(), spec.getResourceAdapterJndiParameters());
    ...
    private static Context convertStringToContext(String jndiParameters, String resourceAdapterJndiParameters) throws NamingException {
        Properties properties = convertStringToProperties(jndiParameters);
        Properties defaultProps = convertStringToProperties(resourceAdapterJndiParameters);
